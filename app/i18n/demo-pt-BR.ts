export const demoPtBR = {
  ...
  homeButtons: {
    btnDocumentos: "Acessar documentos",
    btnFormularios: "Preencher checklists",
    btnOuvidoria: "Acessar ouvidoria",
    btnTreinamentos: "Anexar comprovantes"
  },
  demoButton: {
    description:
...
export default demoPtBR
export type DemoTranslations = typeof demoPtBR
