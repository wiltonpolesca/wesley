...
const emptyState = require("../../assets/images/empty-box.png")
...
const $heading: TextStyle = { textAlign: "center", paddingHorizontal: spacing.lg, paddingTop: spacing.lg }
