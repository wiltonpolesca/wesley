...
export const OuvidoriaScreen: FC<DemoTabScreenProps<"ListaOuvidoria">> =
  observer(function listaOuvidoriaScreen(_props) {
    ...
    useEffect(() => {
      ; (async function load() {
        setIsLoading(true)
        await episodeStore.fetchEpisodes("1")
        setIsLoading(false)
      })()
    }, [episodeStore])
    ...
    async function manualRefresh() {
      setRefreshing(true)
      await Promise.all([episodeStore.fetchEpisodes("1"), delay(750)])
      setRefreshing(false)
    }
    ...
    return (
      ...
      >
        ...
        >
          <Tab.Item
            title={translate("listaOuvidoriaScreen.formsDisponiveis")}
          ...
          />
          <Tab.Item
            title={translate("listaOuvidoriaScreen.formsRespondidos")}
            containerStyle={$containerTabButton}
        ...
        <TabView value={activeTab} onChange={setActiveTab} animationType="spring" containerStyle={$containerConteudoAba} tabItemContainerStyle={$containerConteudoAba}>
          <TabView.Item style={{ width: '100%'}}>
            <View style={{flex:1}}>
              <Text preset="subheading" style={$title}>{translate("listaOuvidoriaScreen.subTitleAbaNovos")}</Text>
              <Dropdown
                ...
                labelField="label"
                valueField="value"
                placeholder={translate("listaOuvidoriaScreen.inputDropdownPlaceholder")}
                value={valueDropdown}
                onChange={item => {
          ...
          <TabView.Item style={{ width: '100%' }}>
            <View style={{ flex: 1 }}>
              <Text preset="subheading" style={$title}>{translate("listaOuvidoriaScreen.subTitleAbaEnviados")}</Text>
              <Dropdown
                style={styles.dropdown}
                placeholderStyle={styles.placeholderStyle}
                selectedTextStyle={styles.selectedTextStyle}
...
const DocCard = observer(function DocCard({
  ...
  const handlePressOpenForm = () => {
    navigation.navigate("Questionario" as never)
  }
  ...
  return (
    <Card
      ...
      LeftComponent={<Icon icon="faOuvidoria" color={colors.palette.neutral800} size={20} containerStyle={$itemIconContainer} style={$itemThumbnail} />}
      FooterComponent={
        <View style={$itemFooter}>
          ...
          >
            <Text
              ...
              weight="medium"
              text={translate("listaOuvidoriaScreen.btnGoForm")}
            />
          </Button>
        </View>
      }
    ...
    <Card
      ...
      HeadingComponent={<View style={$metadata}>
        <Text
          ...
          size="xxs"
        >
          {translate("listaOuvidoriaScreen.sentDateTitle")}
        </Text>
        <Text
          style={$metadataText}
          size="xxs"
        ...
        <View style={$itemFooter}>
          ...
          >
            <Text
              ...
              style={$btnTextOpenForm}
              weight="medium"
              text={ translate("listaOuvidoriaScreen.btnViewForm") }
            />
          </Button>
        </View>
      }
